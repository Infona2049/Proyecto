...
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.smtp.EmailBackend') #Backend de correo SMTP
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')#Servidor SMTP de Gmail
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='ecofactproyect@gmail.com')#Usuario/Correo SMTP
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='ynoffupvodsyozjl')  #Contraseña o App Password SMTP
EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)  # Puerto SMTP (debe ser número)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=True, cast=bool)  # TLS habilitado (debe ser booleano)
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='ecofactproyect@gmail.com')   #Correo desde el que se envían los